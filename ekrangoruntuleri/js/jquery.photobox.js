...
;(function($, doc, win){
    ...
    APControl = {
        ...
        play : function(){
            ...
            APControl.setTitle('Otomatik oynatmayı durdurmak için tıkla');
        ...
        pause : function(){
            ...
            APControl.setTitle('Otomatik oynatmayı başlatmak için tıkla');
        ...
        setTitle : function(text){
            if(text)
                autoplayBtn.prop('title', text + ' (Her ' + options.time/1000 + ' saniyede bir)' );
        },
